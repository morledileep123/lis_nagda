				...
				<div class="col-md-12 m-auto ">
					<div class="box box-primary">
						<div class="box-header with-border">
							...
							<form action="{{route('your-profile.update',$getUserData->id)}}" method="post" role="form" enctype="multipart/form-data">
							@csrf
                             @method('PUT')
							...
							<div class="row ">
								<div class="col-md-6" style="margin-top:10px;"> 
									...
									<input type="text" name="name" class="form-control" placeholder="name" value="{{$getUserData->f_name}} {{$getUserData->l_name}}" required="" autocomplete="name" autofocus="" readonly="">
									@error('name')
						       ...
						       <div class="col-md-6" style="margin-top:10px;">
						            ...
						            <input id="email" type="email" class="form-control  " value="{{$getUserData->email}}" readonly="">
					            	@error('email')
	                                  <span class="text-danger" role="alert">
	                                  <strong>{{ $message }}</strong>
	                                </span>
								...
								<div class="col-md-6" style="margin-top:10px;">
									...
									<input type="text" value="{{date('Y-m-d',strtotime($getUserData->dob))}}" class="form-control datepicker" name="dob" required="" autocomplete="dob" autofocus="" id="datepicker" data-date-format="yyyy-mm-dd" readonly="">
									@error('dob')
	                                  <span class="text-danger" role="alert">
	                                  <strong>{{ $message }}</strong>
	                                </span>
								...
								<div class="col-md-6" style="margin-top:10px;">
									...
									<input type="text" value="{{date('Y-m-d',strtotime($getUserData->admission_date))}}" class="form-control datepicker" name="created_at" required="" autocomplete="created_at" autofocus="" id="datepicker" data-date-format="yyyy-mm-dd" readonly="">
									@error('created_at')
	                                  <span class="text-danger" role="alert">
	                                  <strong>{{ $message }}</strong>
	                                </span>
							...
							<div class="row form-group">
								<div class="col-md-6" style="margin-top:10px;">
									...
									<div class="input-group">
					             	...
					             	<input type="text" name="mobile" class="form-control " placeholder="Mobile Number" value="{{$getUserData->s_mobile}}"  autocomplete="mobile" autofocus="" readonly="">
									</div>
					             	@error('mobile')
		                                <span class="text-danger" role="alert">
		                                 <strong>{{ $message }}</strong>
								...
								<div class="col-md-6" style="margin-top:10px;">
									...
									<div class="input-group">
										<div class="input-group-addon">
					             		...
					             		<input type="text" name="alternative_mo_no" class="form-control" placeholder="Enter Alternate Number" value="{{$getUserData->optional_mobile_number}}"> 
									</div>
