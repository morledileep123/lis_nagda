...
<div class="container">
       <div class="card shadow mb-4">
          ...
          <!-- Card Body -->
          <div class="card-body">
              <form action="{{route('discount_type_store')}}" method="post" id="form_submit" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-md-12">
                       <div class="row">               
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                           ...
                           <input type="text" class="form-control onlyDigit input-sm" id="name"  name="discount_type_name"  value="{{old('discount_type_name')}}" >
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="discount_type_desc">Discount type description</label>
                         <textarea type="text" name="discount_type_desc" class="form-control ">{{old('discount_type_desc')}}</textarea> 
                    ...
                    <div class="col-md-6">
                        ...
                        <label for="shrt_desc">Short description</label>
                         <input type="text" name="shrt_desc" class="form-control " value="{{old('shrt_desc')}}"   >
                          @error('shrt_desc')
                          <span class="text-danger">
                            <strong>{{$message}}</strong>
                          </span>
