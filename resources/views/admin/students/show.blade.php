        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="card-title">Show Student <a href="{{route('student_detail.index')}}" class="btn btn-sm btn-primary pull-right fa fa-arrow-left"> Back</a></h6>
                </div>
                <div class="card-body">
                    <div class="row ">
                                ...
                                <div class="tab-pane tab  active" id="basic_details" >
                                    <section>
                                        ...
                                        <div class="row form-group"> --}}
                                            ...
                                            <div class="col-md-3 col-sm-6 form-group col-xs-6">
                                            <label class="required">Cast Name</label>
                                            <input type="" name="" value="{{$student->cast}}" class="form-control" readonly>
                                            </div>
                                             <div class="col-md-4 col-sm-6 form-group col-xs-6">
                                            <label class="required">Cast Certificate No.</label>
                                            <input type="" name="" value="{{$student->cast_cert_no}}" class="form-control" readonly>
                                            </div>
                                            <div class="col-md-4 col-sm-6 form-group col-xs-6">
                              ...
                              <div class="row" style="margin-top: 10px;">
                                ...
                                <div class="col-md-10">
                                  <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                      <label>Name</label>
                                      <input readonly=""  class="form-control" value="{{$guard_info->g_name}}">
                                    </div>
                                    <div class="col-md-3">
                                      <label>Mobile</label>
