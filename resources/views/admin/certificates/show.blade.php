     ...
     <div class="col-md-12 mb-4" style="margin-left: 50px;">
        <div class="row mt-3">
          ...
          <div class="col-md-12 cert-type" >
            <span>
            <u><strong>{{__('SCHOOL LEAVING CERTICATE') }}</strong></u> 
      ...
      <div class="col-md-12" style="margin-left: 50px; ">
        <div class="row ">
          <div class="col-md-6">
            <span style="font-size: 20px;">TC. No:- {{$showRequest->studentInfo->student_batch->batch_name}}/{{$showRequest->cert_id }} </span>
      ...
      <div class="row " style="margin-left: 70px; ">
        <div class="col-md-12 " style="font-size: 20px; margin-top: 50px;">
           ...
           4.&nbsp;&nbsp;Nationality:- <strong>INDIAN</strong><br>
           {{-- 4.&nbsp;&nbsp;Nationality:- <strong>{{$showRequest->studentInfo->acadmic_country}}n</strong><br> --}}
           ...
           11.Subjects studied:- <strong>
           {{--  @if($subjectName->assign_subjectId !=null)
