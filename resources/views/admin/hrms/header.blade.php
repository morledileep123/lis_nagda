    ...
    <div class="card-body">
      <div class="row">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
	              ...
	              <div class="card {{Request::url() == Route('employees.index') ? 'border-left-success bg-primary text-white' : 'border-left-primary'}} shadow h-100 py-2">
	                <div class="card-body">
	                  <div class="row no-gutters align-items-center">
	                    <div class="col mr-2">
	                      <div class="text-xs font-weight-bold  text-uppercase mb-1">Employees Details</div>
