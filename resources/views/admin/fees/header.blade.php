...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
   ...
   {{--    <div class="col-xl-3 col-md-6 mb-4">
      <a href="{{route('pay_dynamic_fee_index')}}" class="">
          <div class="card {{Request::url() == route('pay_dynamic_fee_index') ? 'border-left-success bg-primary text-white' : 'border-left-primary'}} shadow h-100 py-2">
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  <div class="text-xs font-weight-bold  text-uppercase mb-1">Pay Dynamic Fees</div>
                </div>
                <div class="col-auto">
                  <i class="fa fa-id-card fa-2x text-gray-300"></i>
                </div>
