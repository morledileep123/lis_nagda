  ...
  <div class="container">
    <div class="card shadow mb-4">
      ...
      <div class="app-title full-right ">
         ...
         @endif
             <div class="card-body">
                <form action="{{route('settings-aboutus.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                  <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          ...
                          <input type="file" name="about_image" id="about_image" class="form-control " value="{{old('about_image')}}" accept="image/x-png,image/gif,image/jpeg">
                          @error('about_image')
                              <span class="text-danger" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                       ...
                       <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                         ...
                         <textarea id="about_des" name="about_des" class="form-control ckeditor" placeholder="Write your message.." required="">{{old('about_des')}}</textarea>
                          @error('about_des')
                              <span class="text-danger" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
