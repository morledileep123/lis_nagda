  ...
  <div class="container">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-2 d-flex flex-row align-items-center justify-content-between">
        <h6 style="font-size: 15px;" class="m-0 font-weight-bold text-primary">Show Principal Messages<h4 class="panel-title"> 
         ...
         <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                    ...
                    <input type="text" name="principals_msg_title" id="principals_msg_title" class="form-control " value="{{$principalmgsDatas->principals_msg_title}}" readonly="">
                </div> 
                <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                    <label for="principals_msg_image"> Image</label><br>
                 ...
                 <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                   ...
                   <textarea id="principals_msg_des" name="principals_msg_des" class="form-control ckeditor" placeholder="Write your message.." readonly="">{{$principalmgsDatas->principals_msg_des}}</textarea>
                </div>
            </div>
          </div>
        </div>
