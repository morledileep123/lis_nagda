    ...
    <div class="card shadow mb-4">
      <div class="card-header py-2 d-flex flex-row align-items-center justify-content-between">
        <h6 style="font-size: 15px;" class="m-0 font-weight-bold text-primary">Principal Messages<h4 class="panel-title"> 
          <a href="{{ url('settings-principal-messages') }}" class="btn btn-primary btn-sm pull-right ">Back</a>
       </h4></h6>
      </div>
      <div class="app-title full-right ">
         ...
         @endif
             <div class="card-body">
                <form action="{{route('settings-principal-messages.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                  <div class="row">
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          <label for="principals_msg_title"> Title</label>
                          <input type="text" name="principals_msg_title" id="principals_msg_title" class="form-control " value="{{old('principals_msg_title')}}" >
                      ...
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          ...
                          <input type="file" name="principals_msg_image" id="principals_msg_image" class="form-control " value="{{old('principals_msg_image')}}" accept="image/x-png,image/gif,image/jpeg">
                       ...
                       <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                         ...
                         <textarea id="principals_msg_des" name="principals_msg_des" class="form-control ckeditor" placeholder="Write your message.." required="">{{old('principals_msg_des')}}</textarea>
