  ...
  <div class="container">
    <div class="card shadow mb-4">
      ...
      <div class="app-title full-right ">
         ...
         @endif
             <div class="card-body">
                <form action="{{route('settings-academics.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                  <div class="row">
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          <label for="academic_title"> Title</label>
                          <input type="text" name="academic_title" id="academic_title" class="form-control " value="{{old('academic_title')}}" required="">
                      ...
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          ...
                          <input type="file" name="academic_image" id="academic_image" class="form-control " value="{{old('academic_image')}}" accept="image/x-png,image/gif,image/jpeg">
                       ...
                       <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                         ...
                         <textarea id="academic_des" name="academic_des" class="form-control ckeditor" placeholder="Write your message.." required="">{{old('academic_des')}}</textarea>
                          @error('academic_des')
                              <span class="text-danger" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
