         ...
         <div class="card-body">
              <div class="row">
                  <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                      ...
                      <input type="text" name="about_title" id="about_title" class="form-control " value="{{$academicDatas->academic_title}}" readonly="">
                  </div> 
                  <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                   ...
                   <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                     ...
                     <textarea id="about_des" name="about_des" class="form-control ckeditor" placeholder="Write your message.." readonly="">{{$academicDatas->academic_des}}</textarea>
                  </div>
              </div>
          </div>
        </div>
