  ...
  <div class="container">
    <div class="card shadow mb-4">
      ...
      <div class="app-title full-right ">
         ...
         @endif
             <div class="card-body">
                <form action="{{route('settings-cbscsection-committees.update',$commitiDatas->commitees_id)}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                  <div class="row">
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          <label for="commitees_title"> Title</label>
                          <input type="text" name="commitees_title" id="commitees_title" class="form-control " value="{{$commitiDatas->commitees_title}}" required="">
                      ...
                      <div class="col-md-6 col-sm-6 col-lg-6 form-group">
                          ...
                          <input type="file" name="commitees_image" id="commitees_image" class="form-control " value="{{$commitiDatas->commitees_image}}" accept="image/*">
                       ...
                       <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                         ...
                         <textarea id="commitees_des" name="commitees_des" class="form-control ckeditor" placeholder="Write your message.." required="">{{$commitiDatas->commitees_des}}</textarea>
                          @error('commitees_des')
                              <span class="text-danger" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
