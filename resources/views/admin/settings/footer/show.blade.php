                ...
                @method('PATCH')
                  <div class="row">
                      <div class="col-md-12 col-sm-12 col-lg-12 form-group">
                          ...
                          <input type="text" name="heading" id="heading" class="form-control " value="{{$footerDatas->heading}}" readonly="">
                          @error('heading')
                      ...
                      <div class="col-md-12 col-xl-12 col-sm-12" style="border:1px solid #eee9e9; " id="footer_setting" ></div>
                       ...
                       <div class="col-md-12 col-sm-6 col-lg-12 form-group">
                         ...
                         <textarea id="footer_des" name="footer_des" class="form-control ckeditor" placeholder="Write your message.." readonly>{{$footerDatas->footer_des}}</textarea>
                          @error('footer_des')
                              <span class="text-danger" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
...
var k =0;
  ...
  $('#footer_setting').append('<div id="row'+k+'"><div class="row form-group "><div class="col-xl-12 col-md-12 col-sm-12"></div><div class="col-sm-6 form-group col-md-6 col-xs-6 "><label class="">Footr Image <strong class="text-danger">*</strong></label><br />@if($footerDatas->footerImages[$k]->footer_image !=null)<a href="{{asset('storage/'.$footerDatas->footerImages[$k]->footer_image)}}" target="_blank">{{file_name($footerDatas->footerImages[$k]->footer_image)}}</a>@else <p>Not Uploaded</p> @endif<input type="hidden" name="g_check[]" class="g_photo" value=""><input type="hidden" name="g_id[]" value="{{$footerDatas->footerImages[$k]->footer_img_id}}"></div><div class="col-md-6 col-sm-6 form-group col-xs-6 "><label class="">Footer Title <strong class="text-danger">*</strong></label><input  type="text" class="form-control" placeholder="Entertitle" name="image_title[]" value="{{$footerDatas->footerImages[$k]->image_title}}" readonly/></div></div><hr></div></div>');
  ...
  $('#footer_setting').append('<div id="row{{$k}}"><div class="row form-group "><div class="col-xl-12 col-md-12 col-sm-12"><a href="#" class="pull-right btn btn-sm btn-danger btn_remove" style="margin:10px 10px 0px 0px" id="{{$k}}"><i class="fa fa-minus"></i></a></div><div class="col-sm-6 form-group col-md-6 col-xs-6 "><label class="">Footr Image <strong class="text-danger">*</strong></label><br />@if($footerDatas->footerImages[$k]->footer_image !=null)<a href="{{asset('storage/'.$footerDatas->footerImages[$k]->footer_image)}}" target="_blank">{{file_name($footerDatas->footerImages[$k]->footer_image)}}</a>@else <p>Not Uploaded</p> @endif<input type="hidden" name="g_check[]" class="g_photo" value=""><input type="hidden" name="g_id[]" value="{{$footerDatas->footerImages[$k]->footer_img_id}}"></div><div class="col-md-6 col-sm-6 form-group col-xs-6 "><label class="">Footer Title <strong class="text-danger">*</strong></label><input  type="text" class="form-control" placeholder="Entertitle" name="image_title[]" value="{{$footerDatas->footerImages[$k]->image_title}}" readonly/></div></div><hr></div></div>');
